            ...
            <div class="modal-body border-1">
                <div class="row p-5" style="height: 500px">
                    <div class="col p-1 m-3" style="margin: auto">
                        <img src="<?php echo $logo_path; ?>" class="img-fluid" style="width">
                    </div>
...
<!-- Login Modal-->
<div class="modal fade bd-example-modal-lg" id="loModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-lg col-sm h-100">
        <div class="modal-content">
            <div class="modal-header bg-primary p-4">
...
<!-- Sign up Modal-->
<div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="signupModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
